 ...
 * WiFi setup
 */
#define IOT_CONFIG_WIFI_SSID            ". The Second One"
#define IOT_CONFIG_WIFI_PASSWORD        "wedonthaveone"
 ...
 */
#define DEVICE_CONNECTION_STRING    "HostName=ConeProject.azure-devices.net;DeviceId=esp8266;SharedAccessKey=TcYKjRNI2SwIt/pqUJCax68vb/e5StNqvCHgsaQ3e+U="
